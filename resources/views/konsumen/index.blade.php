            ...
            <table id="table-konsumen" class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-secondary-100">
                    <tr class="table-row-hover">
                        ...
                        <td class="px-6 py-4 font-medium text-secondary-900">Toko Laris Manis</td>
                        <td class="px-6 py-4 text-sm text-secondary-700">Bpk. Sudirman</td>
                        <td class="px-6 py-4 text-right space-x-1">
                            <button onclick="handleEdit('KON-001', 'Toko Laris Manis', 'Bpk. Sudirman')" class="inline-flex items-center justify-center p-2 text-secondary-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg>
                            </button>
                            <button onclick="confirmDelete('Toko Laris Manis')" class="inline-flex items-center justify-center p-2 text-secondary-400 hover:text-danger-600 hover:bg-danger-50 rounded-lg transition-colors">
                    ...
                    <tr class="table-row-hover">
                        ...
                        <td class="px-6 py-4 font-medium text-secondary-900">CV. Abadi Jaya</td>
                        <td class="px-6 py-4 text-sm text-secondary-700">Ibu Siti Khadijah</td>
                        <td class="px-6 py-4 text-right space-x-1">
                            <button onclick="handleEdit('KON-002', 'CV. Abadi Jaya', 'Ibu Siti Khadijah')" class="inline-flex items-center justify-center p-2 text-secondary-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg>
                            </button>
                            <button onclick="confirmDelete('CV. Abadi Jaya')" class="inline-flex items-center justify-center p-2 text-secondary-400 hover:text-danger-600 hover:bg-danger-50 rounded-lg transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                            </button>
                        </td>
                    </tr>
